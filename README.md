...
舍弃20250407的回撤控制超额，模型能在0418-0625保持对wind全A的跟踪（8%+），
【0418-0628】跑不出来超额**猜测**是
1.【0418-0628】的大回撤时，我们都仅持仓3只ETF标的，在过少的标持有的前提下获得超额，对周度预测能力要求极高，
然而
2.对于周频调仓，我们还没来得及对参数进行优化，仍然需要更适应的参数提取特征
